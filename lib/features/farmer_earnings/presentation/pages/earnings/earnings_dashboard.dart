          ...
          if (snapshot.hasData) {
            for (var doc in snapshot.data!.docs) {
              ...
              for (var item in items) {
                ...
                cropEarnings[name] =
                    (cropEarnings[name] ?? 0) + itemTotal.toDouble();
              }
            }
          }
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 8),
                      const Text(
                        "Live data from confirmed orders",
                        style: TextStyle(
                  ...
                  ...cropEarnings.entries
                      .map(
                        (e) => _cropEarningsItem(
                          ...
                          (e.value / totalEarnings).clamp(0.1, 1.0),
                        ),
                      )
                      .toList(),
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const Text(
            "Visual trend calculation pending more data points",
