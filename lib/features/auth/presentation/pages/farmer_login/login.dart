...
import 'package:customer_app/features/auth/presentation/pages/farmer_signup2/create_account.dart';
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () async {
                          ...
                          final success = await context.read<AuthProvider>().signIn(emailController.text, passwordController.text, expectedRole: role);
                          if (success && context.mounted) {
                            Navigator.popUntil(context, (r) => r.isFirst);
                          } else if (context.mounted) {
                            ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Login Failed or Incorrect Role')));
                          }
                        },
                        child: const Row(
